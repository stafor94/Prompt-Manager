...
const APP_SHELL = [
  ...
  "./version-display.js?v=1.1.0",
  "./library-controls.js?v=1.1.0",
  "./library-controls.css?v=1.0.5",
  "./archive-six-columns.js?v=1.1.0",
  "./archive-six-columns.css?v=1.0.7",
  "./image-navigation.js?v=1.1.0",
  "./tab-persistence.js?v=1.1.0",
  "./storage-summary.js?v=1.1.0",
  "./storage-quota.mjs",
  ...
  "./prompt-organization-backup.css?v=1.1.0",
