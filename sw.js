...
const APP_SHELL = [
  ...
  "./styles.css?v=1.5.6",
  "./fixes.css?v=1.5.6",
  "./detail-layout.css?v=1.5.6",
  "./archive-grouping.css?v=1.5.6",
  "./image-viewer-fit.css?v=1.5.6",
  "./tag-ui-fixes.css?v=1.5.6",
  "./favorite-editor-ui.css?v=1.5.6",
  "./app.js?v=1.5.6",
  "./prompt-db.mjs",
  "./archive-pagination-core.mjs",
  "./card-favorite.js?v=1.5.6",
  "./card-favorite-core.mjs",
  "./prompt-version.mjs",
  "./llm-filter.js?v=1.5.6",
  "./editor-tools.js?v=1.5.6",
  "./editor-title-extractor.mjs",
  "./navigation.js?v=1.5.6",
  "./ui-enhancements.js?v=1.5.6",
  "./archive-llm-filter.js?v=1.5.6",
  "./update-manager.js?v=1.5.6",
  "./version-display.js?v=1.5.6",
  "./library-controls.js?v=1.5.6",
  "./library-controls.css?v=1.5.6",
  "./archive-six-columns.js?v=1.5.6",
  "./archive-six-columns.css?v=1.5.6",
  "./archive-viewer-layout.js?v=1.5.6",
  "./archive-viewer-layout-core.mjs",
  "./archive-viewer-layout.css?v=1.5.6",
  "./image-navigation.js?v=1.5.6",
  "./image-metadata.mjs",
  "./image-viewer-fit.js?v=1.5.6",
  "./image-viewer-fit-core.mjs",
  "./tab-persistence.js?v=1.5.6",
  "./storage-summary.js?v=1.5.6",
  "./storage-quota.mjs",
  "./release-notes.js?v=1.5.6",
  "./release-notes-core.mjs",
  "./release-notes.css?v=1.5.6",
  "./CHANGELOG.md?v=1.5.6",
  "./prompt-organization-backup.js?v=1.5.6",
  "./prompt-organization-backup-core.mjs",
  "./prompt-organization-backup.css?v=1.5.6",
  "./prompt-tag-core.mjs",
  "./manifest.webmanifest?v=1.5.6",
  "./icons/icon.svg",
