const CACHE_NAME = "prompt-manager-shell-v38";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.2.1",
  "./fixes.css?v=1.2.1",
  "./detail-layout.css?v=1.2.1",
  "./archive-grouping.css?v=1.2.1",
  "./image-viewer-fit.css?v=1.2.1",
  "./tag-ui-fixes.css?v=1.2.1",
  "./app.js?v=1.2.1",
  "./prompt-version.mjs",
  "./llm-filter.js?v=1.2.1",
  "./editor-tools.js?v=1.2.1",
  "./editor-title-extractor.mjs",
  "./navigation.js?v=1.2.1",
  "./ui-enhancements.js?v=1.2.1",
  "./archive-llm-filter.js?v=1.2.1",
  "./update-manager.js?v=1.2.1",
  "./version-display.js?v=1.2.1",
  "./library-controls.js?v=1.2.1",
  "./library-controls.css?v=1.2.1",
  "./archive-six-columns.js?v=1.2.1",
  "./archive-six-columns.css?v=1.2.1",
  "./image-navigation.js?v=1.2.1",
  "./image-viewer-fit.js?v=1.2.1",
  "./image-viewer-fit-core.mjs",
  "./tab-persistence.js?v=1.2.1",
  "./storage-summary.js?v=1.2.1",
  "./storage-quota.mjs",
  "./release-notes.js?v=1.2.1",
  "./release-notes-core.mjs",
  "./release-notes.css?v=1.2.1",
  "./CHANGELOG.md?v=1.2.1",
