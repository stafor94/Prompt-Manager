const CACHE_NAME = "prompt-manager-shell-v23";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.0.3",
  "./fixes.css?v=1.0.3",
  "./detail-layout.css?v=1.0.3",
  "./archive-grouping.css?v=1.0.3",
  "./app.js?v=1.0.3",
  "./prompt-version.mjs",
  "./llm-filter.js?v=1.0.3",
  "./editor-tools.js?v=1.0.3",
  "./navigation.js?v=1.0.3",
  "./ui-enhancements.js?v=1.0.3",
