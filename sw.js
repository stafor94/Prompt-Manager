const CACHE_NAME = "prompt-manager-shell-v52";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.7.0",
  "./fixes.css?v=1.7.0",
  "./detail-layout.css?v=1.7.0",
  "./archive-grouping.css?v=1.7.0",
  "./image-viewer-fit.css?v=1.7.0",
  "./tag-ui-fixes.css?v=1.7.0",
  "./favorite-editor-ui.css?v=1.7.0",
  "./app.js?v=1.7.0",
  "./prompt-db.mjs",
  "./llm-registry.mjs",
  "./archive-pagination-core.mjs",
  "./card-favorite.js?v=1.7.0",
  "./card-favorite-core.mjs",
  "./prompt-version.mjs",
  "./llm-filter.js?v=1.7.0",
  "./editor-tools.js?v=1.7.0",
  "./editor-title-extractor.mjs",
  "./navigation.js?v=1.7.0",
  "./ui-enhancements.js?v=1.7.0",
  "./archive-llm-filter.js?v=1.7.0",
  "./update-manager.js?v=1.7.0",
  "./version-display.js?v=1.7.0",
  "./library-controls.js?v=1.7.0",
  "./library-controls.css?v=1.7.0",
  "./archive-six-columns.js?v=1.7.0",
  "./archive-six-columns.css?v=1.7.0",
  "./archive-viewer-layout.js?v=1.7.0",
  "./archive-viewer-layout-core.mjs",
  "./archive-viewer-layout.css?v=1.7.0",
  "./image-navigation.js?v=1.7.0",
  "./image-metadata.mjs",
  "./image-viewer-fit.js?v=1.7.0",
  "./image-viewer-fit-core.mjs",
  "./tab-persistence.js?v=1.7.0",
  "./storage-summary.js?v=1.7.0",
  "./storage-quota.mjs",
  "./release-notes.js?v=1.7.0",
  "./release-notes-core.mjs",
  "./release-notes.css?v=1.7.0",
  "./CHANGELOG.md?v=1.7.0",
  "./prompt-organization-backup.js?v=1.7.0",
  "./prompt-organization-backup-core.mjs",
  "./prompt-organization-backup.css?v=1.7.0",
  "./prompt-tag-core.mjs",
