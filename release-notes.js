...
- 1장 이미지 뷰어에서 파일명을 제거하고 프롬프트 제목과 이미지 비율·원본 해상도만 표시하도록 정리했습니다.
- 상세 화면에서 연 1장 이미지도 프롬프트 제목을 함께 표시하도록 보완했습니다.
- 2장 이미지 뷰어에서는 왼쪽 이미지의 프롬프트 제목 하나만 표시하고 두 장이 열렸음을 \`외 1\`로 표기하도록 변경했습니다.
