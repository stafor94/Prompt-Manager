...
- 보관함에서 \`2장보기\`를 선택한 경우 기존 1장 뷰어를 먼저 연 뒤 뒤늦게 전환하던 방식을 제거했습니다.
- \`2장보기\` 상태에서는 이미지 클릭을 즉시 가로채 두 장 전용 뷰어를 직접 열도록 변경해 한 장 뷰어와의 경합을 없앴습니다.
- 두 장 뷰어에서는 좌우 스와이프가 두 장 단위로 이동하고 닫기·뒤로가기 기록도 독립적으로 처리합니다.
`;
